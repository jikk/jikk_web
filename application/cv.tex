...
%  
  %  The insight behind this approach is to alleviates the high overhead common
  %  to the most existing dynamic security solutions without compromising the
  %  defense capability.
...
%  We avoid the problems suffered by previous approaches, by
