...
University education should provide opportunities for student to cultivate their
...
%
As {\it sources} first being compiled into {\it objects} , it exposes its
...
at build phase. % as we {\it link} objects to produce a binary. 
%
At runtime, we can consider tools from different levels for the
instrumentations; \ie {\it program loader} or {\it VM-hypervisor} of different
types.
%
This course will be considered as a advanced compiler course aiming to deliver 
