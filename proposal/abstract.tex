...
in our previous works to in-line event collector and communication stubs to the
...
model framework. With this analytic model, we expect to analyze and predict
performance changes in respond to the modifications that we would make to our
system prior to real execution. 
